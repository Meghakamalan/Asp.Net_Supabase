...
namespace TicketTracker.Models
{
        ...
        : IDesignTimeDbContextFactory<TicketDbContext>
    {
        public TicketDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql("Host=aws-1-us-west-2.pooler.supabase.com;Database=postgres;Username=postgres.nuasecxjbkgylczutmjl;Password=PP@2tickettracker;SSL Mode=Require;Trust Server Certificate=true"
            );
